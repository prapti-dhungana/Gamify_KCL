...
public class GUI extends JFrame {
    ...
    public GUI() {
        ...
        try {
            backgroundImage = ImageIO.read(new File("C:\\Documents\\BlueJ projects\\Gamify_KCL-gui\\background.jpg")); // Replace with your image path
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        transparentPanel.setPreferredSize(new Dimension(100, 250));

        // Add the transparent panel to the frame
        add(transparentPanel);
        
         // Create a leadboard scroll pane
        String[] users = {"Alex         50", "Jame         30", "Bobi           36", "Jane          37"};
